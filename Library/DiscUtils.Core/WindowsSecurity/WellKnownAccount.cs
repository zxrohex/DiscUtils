...
internal class WellKnownAccount
{
    ...
    private static readonly WellKnownAccount[] accounts = new WellKnownAccount[]
    {
        ...
        new WellKnownAccount { WellKnownValue = WellKnownSidType.AccountAdministratorSid, IsAbsolute = true, Sid = "S-1-5-21-1234567890-1234567890-1234567890-500", SddlForm = "LA" },
